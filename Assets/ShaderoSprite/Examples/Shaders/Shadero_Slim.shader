...
_SpriteSheetUVAnimPack_Blend_1("_SpriteSheetUVAnimPack_Blend_1", Range(0, 1)) = 0.802
...
_AutomaticLerp_Speed_1("_AutomaticLerp_Speed_1", Range(0, 1)) = 0.405
...
float2 _Simple_Displacement_1 = SimpleDisplacementUV(_SpriteSheetUVAnimPack_1,0,NewTex_5.g*NewTex_5.a,0.071);
...
float2 RotationUV_1 = RotationUV(i.texcoord,0,0.5,0.5,-0.38);
...
NewTex_4 = lerp(NewTex_4,NewTex_4*NewTex_4.a + NewTex_2*NewTex_2.a,0.718 * NewTex_4.a);
