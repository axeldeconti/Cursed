...
Shader "Shadero Customs/Shader_GlitchScreen_UI"
{
Properties
{
[PerRendererData] _MainTex("Sprite Texture", 2D) = "white" {}
DistortionUV_WaveX_1("DistortionUV_WaveX_1", Range(0, 128)) = 4.88
DistortionUV_WaveY_1("DistortionUV_WaveY_1", Range(0, 128)) = 12.327
DistortionUV_DistanceX_1("DistortionUV_DistanceX_1", Range(0, 1)) = 0.856
DistortionUV_DistanceY_1("DistortionUV_DistanceY_1", Range(0, 1)) = 0.3
DistortionUV_Speed_1("DistortionUV_Speed_1", Range(-2, 2)) = -0.833
DoodleUV_Size_1("DoodleUV_Size_1", Range(2, 16)) = 8
DoodleUV_Frame_1("DoodleUV_Frame_1", Range(1, 16)) = 6
_Hologram_Value_1("_Hologram_Value_1", Range(0, 1)) = 0.773
_Hologram_Speed_1("_Hologram_Speed_1", Range(0, 4)) = 1.833
__CompressionFX_Value_1("__CompressionFX_Value_1", Range(1, 16)) = 14.546
_MaskAlpha_Fade_1("_MaskAlpha_Fade_1", Range(0, 1)) = 0.691
_CircleFade_PosX_1("_CircleFade_PosX_1", Range(-1, 2)) = 0.283
_CircleFade_PosY_1("_CircleFade_PosY_1", Range(-1, 2)) = 0.365
_CircleFade_Size_1("_CircleFade_Size_1", Range(-1, 1)) = 0.349
_CircleFade_Dist_1("_CircleFade_Dist_1", Range(0, 1)) = 0.542
...
float2 DoodleUV_1 = DoodleUV(DistortionUV_1,DoodleUV_Size_1,DoodleUV_Frame_1);
float4 _Hologram_1 = Hologram(DoodleUV_1,_MainTex,_Hologram_Value_1,_Hologram_Speed_1);
float4 _CompressionFX_1 = CompressionFX(i.texcoord,_MainTex,__CompressionFX_Value_1);
float4 MaskAlpha_1=_Hologram_1;
MaskAlpha_1.a = lerp(_CompressionFX_1.a * _Hologram_1.a, (1 - _CompressionFX_1.a) * _Hologram_1.a,_MaskAlpha_Fade_1);
float4 _CircleFade_1 = Circle_Fade(MaskAlpha_1,i.texcoord,_CircleFade_PosX_1,_CircleFade_PosY_1,_CircleFade_Size_1,_CircleFade_Dist_1);
