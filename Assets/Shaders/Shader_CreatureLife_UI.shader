...
Shader "Shadero Customs/Shader_CreatureLife_UI"
{
Properties
{
[PerRendererData] _MainTex("Sprite Texture", 2D) = "white" {}
LiquidUV_WaveX_1("LiquidUV_WaveX_1", Range(0, 2)) = 0.305
LiquidUV_WaveY_1("LiquidUV_WaveY_1", Range(0, 2)) = 0.866
LiquidUV_DistanceX_1("LiquidUV_DistanceX_1", Range(0, 1)) = 0
LiquidUV_DistanceY_1("LiquidUV_DistanceY_1", Range(0, 1)) = 0.584
LiquidUV_Speed_1("LiquidUV_Speed_1", Range(-2, 2)) = 0.465
